      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-8 pt-6 border-t-2 border-purple-100">
            ...
            <p className="text-xs text-slate-500 mb-4">Create coupon codes for <span className="font-bold">Add Money</span>. Example: <span className="font-mono font-bold text-purple-700">ADD10</span> with <span className="font-bold">10% Extra</span> → user enters <span className="font-bold">5000 BDT</span>, bonus <span className="font-bold">+500 BDT</span>, total <span className="font-bold">5500 BDT</span> shown in box (payable foreign = base BDT ÷ rate, bonus added to total). Admin sets any % you want, create multiple codes.</p>
            <form onSubmit={saveCoupon} className="space-y-3 bg-purple-50/50 border border-purple-100 rounded-xl p-4 mb-4">
              ...
              <p className="text-[11px] text-purple-600 font-medium">💡 Tip: Creating coupon automatically publishes a visible Offer with same code so users see <span className="font-mono">ADD10</span> in Home offers carousel. Valid for Add Money — <span className="font-bold">Admin sets any % (e.g. 5%, 12%, 20%) and it is added to total BDT shown in exchange box. Multiple coupons supported.</span></p>
            </form>
