...
export const normalizeDeposit = (item: AnyRecord = {}): Deposit => ({
  ...
  baseBdtAmount: asNumber(value(item, 'baseBdtAmount', 'base_bdt_amount')),
  bonusBdt: asNumber(value(item, 'bonusBdt', 'bonus_bdt')),
  totalBdtAmount: asNumber(value(item, 'totalBdtAmount', 'total_bdt_amount')),
